// pywws.js
//
// Contains pywws datastore parsers for raw, hourly, daily, monthly, as well as a
// combined getAll function that gets the data for all of them in one call.
//
...
module.exports = function (app) {
  ...
  var iniparser   = require('./pywws.iniparser')(app);

  // Parse the 'raw' storage
  //
  // Example file name: raw/2014/2014-12/2014-12-03.txt
  //
